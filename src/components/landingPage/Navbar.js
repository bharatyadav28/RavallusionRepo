...
const Navbar = () => {
  return (
    <div className="absolute  top-0 !w-full z-[1000] md:px-[8%] xl:px-[9%] backdrop-blur-lg ">
      ...
      <nav className="p-5 w-full flex justify-between items-center backdrop-blur-lg navbar  z-10">
        <div className=" ">
          <i className="text-2xl xl:text-3xl font-medium">Ravallusion</i>
        </div>
        <CustomButton className="mr-5 text-base xl:text-xl !m-0">
          Login
        </CustomButton>
      </nav>
