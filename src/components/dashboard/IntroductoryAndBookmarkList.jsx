...
import { useGetVideoProgressQuery } from "@/store/Api/video-progress";
          ...
          subItems.map((items) => {
            ...
            return (
              <LessonCard
                ...
                duration={`${timeDuration?.hours}:${timeDuration?.minutes}:${timeDuration?.seconds}`}
...
export const LessonCard = ({
  ...
  console.log("Video Progress", videoProgressData);
      ...
      >
        ...
        <div className="absolute rounded-t-xl z-50 bottom-0 w-full h-[6px] bg-gray-300 rounded-full mt-1 overflow-hidden">
          <div
            ...
            style={{
              width: `${videoProgressData?.data?.videoProgress.percentageWatched}%`,
            }}
          ></div>
        </div>
      </div>
