...
import { CourseProgressBar } from './AssignmentSubmitList';
import { Button } from '../ui/button';
import SubscriptionDetails from '../loginSignupFlow/SubscriptionDetails';
import { ChevronRight } from 'lucide-react';
import { BookmarkBold } from '@/lib/svg_icons';
    ...
    return (
        <div className='col-span-12 lg:col-span-8 lg:mr-7'>
            ...
            <div className='my-2 md:my-6 flex flex-col md:flex-row items-center justify-between md:gap-x-8 gap-y-2 w-full h-auto md:h-48'>
                ...
                <div className='bg-[var(--card)] rounded-2xl flex-grow basis-0 h-full p-4 w-full cursor-pointer' onClick={() => router.push('/dashboard/bookmarked-videos')}>
